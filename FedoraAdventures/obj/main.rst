...
Hexadecimal [16-Bits]
                              ...
                              1 ;;ARCHIVO cabecera para funciones de render
                              2 
...
Hexadecimal [16-Bits]
                              ...
                              8 .area _CODE
                              9 
                             10 ;;Las entidades tienen 7 atributos, cordenada x,y, ancho y alto,
                             11 ;;velocidad x e y, y color
                             12 ;;aqui estan puestas las caracteristicas del player
                             13 
                             14 ;;.globl cpct_disableFirmware_asm
                             15 ;;.globl rendersys_init
                             16 ;;.globl create_entity
                             17 ;;.globl getEntityInArray
                             18 ;;.globl getNumEntities
                             19 ;;.globl rendersys_update
                             20 
   406D 14 14 02 08 01 01    21 player: .db 20, 20, 2, 8, 1, 1, 0xFF
        FF
                             22 
                             23 ;;
                             24 ;; MAIN function. This is the entry point of the application.
                             25 ;;    _main:: global symbol is required for correctly compiling and linking
                             26 ;;
   4074                      27 _main::
                             28    
   4074 CD B0 40      [17]   29    call cpct_disableFirmware_asm
                             30 
   4077 CD 8B 40      [17]   31    call rendersys_init
                             32 
   407A 21 6D 40      [10]   33    ld hl, #player
   407D CD 52 40      [17]   34    call create_entity
                             35    ;; Loop forever
   4080                      36 loop:
   4080 CD 49 40      [17]   37       call getEntityInArray
   4083 CD 4E 40      [17]   38       call getNumEntities
   4086 CD 8C 40      [17]   39       call rendersys_update
   4089 18 F5         [12]   40    jr    loop
